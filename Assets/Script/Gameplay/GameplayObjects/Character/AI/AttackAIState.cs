...
namespace Survival.Game.Gameplay.GameplayObjects.Character.AI
{
    public class AttackAIState : AIState
    {
        ...
        private Actions.Action m_CurAttackAction;

        List<Actions.Action> m_AttackActions;
        ...
        {
            m_AttackActions = new List<Actions.Action>();
        ...
        private Actions.Action ChooseAttack()
        {
