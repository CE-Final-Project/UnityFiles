...
using Avatar = Survival.Game.Gameplay.Configuration.Avatar;

namespace Survival.Game.Gameplay.GameplayObjects.Character
{
    /// <summary>
    ...
    public class NetworkAvatarGuidState : NetworkBehaviour
    {
        ...
        Configuration.Avatar m_Avatar;

        public Configuration.Avatar RegisteredAvatar
        {
            get
            {
                if (m_Avatar == null)
