    ...
    public class HeroEmoteBar : MonoBehaviour
    {
        ...
        public void OnButtonClicked(int buttonIndex)
        {
            if (m_InputSender != null)
            {
                switch (buttonIndex)
                {
                    case 0: m_InputSender.RequestAction(GameDataSource.Instance.Emote1ActionPrototype, ClientInputSender.SkillTriggerStyle.UI); break;
                    case 1: m_InputSender.RequestAction(GameDataSource.Instance.Emote2ActionPrototype, ClientInputSender.SkillTriggerStyle.UI); break;
                    case 2: m_InputSender.RequestAction(GameDataSource.Instance.Emote3ActionPrototype, ClientInputSender.SkillTriggerStyle.UI); break;
                    case 3: m_InputSender.RequestAction(GameDataSource.Instance.Emote4ActionPrototype, ClientInputSender.SkillTriggerStyle.UI); break;
                }
            }
