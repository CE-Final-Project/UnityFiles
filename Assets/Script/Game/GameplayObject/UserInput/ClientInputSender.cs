...
namespace Script.Game.GameplayObject.UserInput
{
    ...
    public class ClientInputSender : NetworkBehaviour
    {
        ...
        private static bool IsReleaseStyle(SkillTriggerStyle style)
        {
            return style is SkillTriggerStyle.KeyboardRelease or SkillTriggerStyle.UIRelease;
        }
        ...
        [SerializeField] private PhysicsWrapper m_PhysicsWrapper;
