...
namespace Script.Game.GameplayObject.Projectiles
{
    /// <summary>
    ...
    public class PhysicsProjectile : NetworkBehaviour
    {
        ...
        [SerializeField]
        CircleCollider2D m_OurCollider;
        ...
        void FixedUpdate()
        {
            ...
            var displacement = transform.right * (m_ProjectileInfo.Speed_m_s * Time.fixedDeltaTime);
        ...
        private void RecvHitEnemyClientRPC(ulong enemyId)
        {
            ...
            if (NetworkManager.Singleton.SpawnManager.SpawnedObjects.TryGetValue(enemyId, out targetNetObject))
            {
                ...
                // }
                Debug.Log("Hit enemy " + targetNetObject.gameObject.name);
            }
        }
    }
}
