...
using Script.Game.GameplayObject.Projectiles;
...
namespace Script.Game.Actions.ConcreteActions
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "TheSurvivor/Actions/Launch Projectile Action")]
    public class LaunchProjectileAction : Action
    {
        ...
        public override bool OnStart(ServerCharacter serverCharacter)
        {
            ...
            serverCharacter.PhysicsWrapper.MeleeAttackPoint.right = Data.Direction;
        ...
        protected void LaunchProjectile(ServerCharacter parent)
        {
            if (!m_Launched)
            {
                ...
                no.transform.right = parent.PhysicsWrapper.MeleeAttackPoint.right;
