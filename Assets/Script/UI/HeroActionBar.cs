...
namespace Script.UI
{
    ...
    public class HeroActionBar : MonoBehaviour
    {
        ...
        void OnButtonClickedDown(ActionButtonType buttonType)
        {
            ...
            m_InputSender.RequestAction(m_ButtonInfo[buttonType].CurAction.ActionID, ClientInputSender.SkillTriggerStyle.UI);
        }
        ...
        void OnButtonClickedUp(ActionButtonType buttonType)
        {
            ...
            m_InputSender.RequestAction(m_ButtonInfo[buttonType].CurAction.ActionID, ClientInputSender.SkillTriggerStyle.UIRelease);
        }
