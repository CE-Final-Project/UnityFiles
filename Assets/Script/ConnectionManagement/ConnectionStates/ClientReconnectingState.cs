...
namespace Survival.Game.ConnectionManagement
{
    ...
    {
        [Inject] private IPublisher<ReconnectMessage> m_ReconnectMessagePublisher;

        private Coroutine m_ReconnectCoroutine;
        private string m_LobbyCode = "";
        private int m_NbAttempts;

        private const float k_TimeBetweenAttempts = 5;

        public override void Enter()
        {
            m_LobbyCode = m_LobbyServiceFacade.CurrentUnityLobby != null
                ? m_LobbyServiceFacade.CurrentUnityLobby.LobbyCode
                : "";
